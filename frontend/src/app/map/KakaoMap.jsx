...
const KakaoMap = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://i12b105.p.ssafy.io:8080/api/substitute/nearby-stores`, {
        params: { userId },
      })
      .then((res) => {
  ...
  const handleStoreClick = (store) => {
    ...
    axios
      .get(`https://i12b105.p.ssafy.io:8080/api/substitute/available-workers`, {
        params: { storeId },
      })
      .then((res) => {
    ...
    // 선택한 지점의 공석 확인(시간)
    axios
      .get(`https://i12b105.p.ssafy.io:8080/api/substitute/available-stores`, {
        params: { storeId },
