...
const RecipeSection = ({ recipe, imageName }) => {
  if (!recipe) return <p className="text-gray-600">레시피 정보는 추후 추가될 예정입니다.</p>;
          ...
          <ol className="space-y-4">
            {recipe.steps.map((step, index) => (
              <li key={index} className="flex gap-4">
                ...
                <span className="text-gray-700 whitespace-pre-wrap">{step}</span>
              </li>
            ))}
          </ol>
        </div>
  ...
  const items = [
    {
      ...
      image: 'americano.png',
      recipe: {
        description: '깊은 에스프레소의 풍미와 뜨거운 물의 조화로운 클래식 커피',
        ingredients: [
    ...
    },
    {
      ...
      image: 'cafelatte.png',
      recipe: {
        description: '부드러운 우유 거품 위로 풍부한 에스프레소를 부어낸 시그니처 음료',
        ingredients: [
          { name: '에스프레소 더블샷', amount: '30ml' },
    ...
    },
    {
      ...
      recipe: {
        description: '에스프레소와 달콤한 티라미수 시럽, 우유가 조화를 이루는 달콤한 음료',
        ingredients: [
    ...
    },
    {
      ...
      recipe: {
        description: '에스프레소 위에 벨벳처럼 부드러운 우유 거품을 얹어 부드럽고 달콤한 맛을 전해주는 커피',
        ingredients: [
          { name: '에스프레소 더블샷', amount: '30ml' },
    ...
    },
    {
      ...
      image: 'flatwhite.png',
      recipe: {
        description: '벨벳 텍스처의 스팀 밀크 위에 에스프레소의 풍부한 풍미를 느낄 수 있는 커피',
        ingredients: [
          { name: '에스프레소 더블샷', amount: '30ml' },
    ...
    },
    {
      ...
      recipe: {
        description: '달콤한 카라멜 소스와 우유, 그 위에 에스프레소를 부어 눈과 입을 즐겁게 해주는 음료',
        ingredients: [
          { name: '에스프레소', amount: '30ml' },
    ...
    },
    {
      ...
      image: 'whitemoca.png',
      recipe: {
        description: '달콤한 화이트 초콜릿 소스와 에스프레소, 부드러운 우유가 만나 감미로운 맛을 주는 모카',
        ingredients: [
    ...
    },
    {
      ...
      recipe: {
        description: '부드러운 바닐라 향이 더해져 깔끔하면서도 달콤하게 즐길 수 있는 콜드브루',
        ingredients: [
          { name: '콜드브루 원액', amount: '100ml' },
    ...
    },
    {
      ...
      recipe: {
        description: '콜드브루를 쉐이크한 시원한 프라페로 더욱 깊고 진한 맛을 느낄 수 있는 음료',
        ingredients: [
          { name: '콜드브루 원액', amount: '100ml' },
    ...
    },
    {
      ...
      recipe: {
        description: '카라멜의 달콤함과 얼음의 시원함이 어우러지는 배리에이션 프라페',
        ingredients: [
          { name: '에스프레소', amount: '30ml' },
          { name: '우유', amount: '180ml' },
          { name: '카라멜 소스', amount: '30ml' },
    ...
    },
    {
      ...
      recipe: {
        description: '진한 초콜릿과 부드러운 에스프레소의 조화로 달콤 쌉싸름한 맛을 즐길 수 있는 음료',
        ingredients: [
    ...
    },
    {
      ...
      recipe: {
        description: '상큼한 여러가지 베리가 블렌딩되어 달콤 상큼한 맛을 즐길 수 있는 스무디',
        ingredients: [
    ...
    },
    {
      ...
      image: 'milktea.png',
      recipe: {
        description: '깊고 진한 홍차에 우유와 타피오카 펄로 고소함을 더한 밀크티',
        ingredients: [
